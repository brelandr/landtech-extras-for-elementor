...
class Module extends Module_Base {
	...
	public static function render_template_content( $template_id, \LandTechExtras\Base\Extras_Widget $widget, $in_loop = false ) {
		...
		if ( ! $template_id ) {
			...
			if ( $in_loop ) {
				// Remove action
				remove_action( 'elementor/frontend/before_render', [ $background, 'add_actions' ], 20, 1 );
				remove_action( 'elementor/frontend/before_render', [ __CLASS__, 'add_render_attributes' ], 10, 1 );
