<div class="wrap about-wrap ee-wrap">
	...
	<div class="o-layout o-layout--middle ee-info-header">
		<div class="o-layout__item u-5/6@desktop">
			<h1><?php _e( "Introducing <strong>Extras for Elementor</strong>", 'elementor-extras' ); ?> <?php echo $version; ?></h1>
			<div class="about-text"><?php _e("With the new Table widget.", 'elementor-extras' ); ?></div>
		</div>
		<div class="o-layout__item u-1/6@desktop">
			<p class="ee-logo ee-logo-brand">
				<a href="<?php echo esc_url( 'https://landtechwebdesigns.com/' ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Land Tech Web Designs, Corp.', 'elementor-extras' ); ?></a>
				<br />
				<a href="<?php echo esc_url( 'mailto:sales@landtechwebdesigns.com' ); ?>"><?php echo esc_html( 'sales@landtechwebdesigns.com' ); ?></a>
			</p>
		</div>
	</div>
