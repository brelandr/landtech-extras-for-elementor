 ...
 * Description:       Premium widgets and extensions for Elementor — licensing and updates via Land Tech Web Designs (License Manager + LandTech API).
 * Version:           2.2.53
 ...
 * Sales and licensing inquiries: sales@landtechwebdesigns.com
 *
 * phpcs:disable PluginCheck.PluginUpdater -- Premium; not hosted on WordPress.org; LandTech updater.
 * 
...
define( 'ELEMENTOR_EXTRAS_VERSION', 						'2.2.53' );
define( 'ELEMENTOR_EXTRAS_PREVIOUS_STABLE_VERSION', 		'2.2.52' );
define( 'ELEMENTOR_EXTRAS_ELEMENTOR_VERSION_REQUIRED', 		'3.5.0' );
define( 'ELEMENTOR_EXTRAS_ELEMENTOR_PRO_VERSION_REQUIRED', 	'3.5.0' );
define( 'ELEMENTOR_EXTRAS_PHP_VERSION_REQUIRED', 			'7.4' );
define( 'ELEMENTOR_EXTRAS_PHP_VERSION_RECOMMENDED', 		'8.0' );
define( 'ELEMENTOR_EXTRAS_TEXTDOMAIN', 						'elementor-extras' );

// LandTech / LMFWC distribution defaults (wp-config may override consumer keys; General settings hold URL / product / secret).
if ( ! defined( 'ELEMENTOR_EXTRAS_DEFAULT_CONSUMER_KEY' ) ) {
	define( 'ELEMENTOR_EXTRAS_DEFAULT_CONSUMER_KEY', '' );
}
if ( ! defined( 'ELEMENTOR_EXTRAS_DEFAULT_CONSUMER_SECRET' ) ) {
	define( 'ELEMENTOR_EXTRAS_DEFAULT_CONSUMER_SECRET', '' );
}

// Licensing (LandTech defaults; wp-config overrides supported — see license helpers).
if ( ! defined( 'ELEMENTOR_EXTRAS_STORE_URL' ) ) {
	define( 'ELEMENTOR_EXTRAS_STORE_URL', 'https://landtechwebdesigns.com' );
}
if ( ! defined( 'ELEMENTOR_EXTRAS_PRODUCT_ID' ) ) {
	define( 'ELEMENTOR_EXTRAS_PRODUCT_ID', 'extras-for-elementor' );
}
define( 'ELEMENTOR_EXTRAS_SL_ITEM_ID', 'elementor_extras' );
define( 'ELEMENTOR_EXTRAS_SL_ITEM_SLUG', 'elementor-extras' );
define( 'ELEMENTOR_EXTRAS_SL_ITEM_NAME', 'Extras for Elementor' );

require_once ELEMENTOR_EXTRAS_PATH . 'includes/licensing/elementor-extras-license-helpers.php';
elementor_extras_load_landtech_licensing_files();
if ( class_exists( 'ElementorExtras_License_Cron' ) ) {
	ElementorExtras_License_Cron::register_daily_license_cron();
}
add_action( 'admin_init', 'elementor_extras_register_license_server_settings' );
...
function elementor_extras_updater() {
	...
	new \ElementorExtras\Landtech_Plugin_Updater( ELEMENTOR_EXTRAS__FILE__ );
}
