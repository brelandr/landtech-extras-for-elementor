...
verify_pack_artifacts() {
	...
	local 	req=(
		...
		"modules/schema/widgets/faq-schema.php"
		"assets/js/viewport-bridge.js"
		"includes/display-conditions/viewport-visibility-bootstrap.php"
		"modules/display-conditions/viewport-breakpoints.php"
		"modules/display-conditions/conditions/viewport.php"
		"modules/tabs/module.php"
		"modules/tabs/widgets/tabs.php"
		"modules/table-of-contents/module.php"
		"modules/table-of-contents/widgets/table-of-contents.php"
		"assets/js/tabs.js"
		"assets/css/tabs.css"
		"assets/js/table-of-contents.js"
		"assets/css/table-of-contents.css"
		"schema/schema-validator.php"
		"includes/plugin.php"
		"includes/search-rest-controller.php"
		"includes/search-term-options-rest.php"
