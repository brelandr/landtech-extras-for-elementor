...
Premium Elementor widgets and extensions. Licensing, validation, and in-dashboard updates use Land Tech Web Designs services (License Manager for WooCommerce + LandTech entitlement API).

== Description ==

**Extras for Elementor** adds widgets and editor extensions on top of Elementor. Enter your license key under the Extras license screen, save **LMFWC REST API credentials** on that page when prompted, and set **Settings → General** license server URL, product ID, and shared secret to match your purchase (same pattern as other Land Tech premium plugins).

Elementor compatibility is documented in the main plugin PHP header (tested-up-to fields).

== Installation ==

1. Install and activate **Elementor**.
2. Install and activate **Extras for Elementor**.
3. Activate your license (Extras license menu) and configure store URLs and LMFWC keys as instructed in your purchase email.
4. Edit pages with Elementor and use **Extras for Elementor** widgets and extensions.

== External Services ==

When you use license or update features, the plugin may contact:

* **Land Tech Web Designs** (License Manager for WooCommerce REST API) — License activation and validation. Data sent can include your site URL, license key, and consumer identifiers you configure. [Terms of Service](https://landtechwebdesigns.com/terms-and-conditions/) · [Privacy Policy](https://landtechwebdesigns.com/privacy-policy/)

* **LandTech plugin update API** — Checks for new versions when WordPress runs update checks. Data sent can include license key, product ID, site URL, and current version.

== Third-party libraries ==

This plugin bundles or references third-party scripts (MIT, GPLv3, GPL-3+, or other licenses as noted under `assets/` and in source headers). Highlights include:

* **jquery-circle-progress**, **jquery.appear**, **LongShadow**, **HC-Sticky**, **jQuery Mobile**, **jquery-visible**, **Parallax Background**, **TableSorter**, **Isotope**, **Infinite Scroll**, **Packery**, **javascript-detect-element-resize**, **tilt.js**, **CLNDR**, **GMAP3**, **Moment.js**, **Slidebars**, **Splittext / GreenSock**, **Magnific Popup**

== Changelog ==

= 2.2.53 =

* Changed: Distribution and licensing aligned with Land Tech Web Designs (LMFWC + LandTech); author/branding and support contact sales@landtechwebdesigns.com; readme structured like Land Tech premium plugins.
* Changed: Ongoing Elementor compatibility (registration hooks, display conditions, optimized markup/Swiper-oriented carousels, caching-related flags).

= 2.2.52 =

* Fixed: Posts Extra — Swiper update to new version
* Fixed: Gallery Slider — Swiper update to new version
...
For licensing, purchases, feature requests, and bug reports, email **sales@landtechwebdesigns.com** or use the contact options on [Land Tech Web Designs](https://landtechwebdesigns.com/).
